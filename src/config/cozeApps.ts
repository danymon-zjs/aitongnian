...
export const COZE_PAT_TOKENS = {
  // 手抄报社PAT令牌
  NEWSPAPER: 'pat_6JWO1CR0FIf5ep4RbPB4oE0ECyAvGS5T0gPF3XKNcSB5D3ICfEGvvQde0JwZWf1F', // 手抄报社PAT令牌
  
  // 童言生画PAT令牌
  SPEAK: 'pat_6JWO1CR0FIf5ep4RbPB4oE0ECyAvGS5T0gPF3XKNcSB5D3ICfEGvvQde0JwZWf1F', // 童言生画PAT令牌
  
  // 创想空间PAT令牌
  CAMERA: 'pat_6JWO1CR0FIf5ep4RbPB4oE0ECyAvGS5T0gPF3XKNcSB5D3ICfEGvvQde0JwZWf1F', // 创想空间PAT令牌
  
  // 语音互动PAT令牌
  VOICE: 'pat_6JWO1CR0FIf5ep4RbPB4oE0ECyAvGS5T0gPF3XKNcSB5D3ICfEGvvQde0JwZWf1F', // 语音互动PAT令牌
} as const;
